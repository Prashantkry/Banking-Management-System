...
int main()
{
	...
	do
	{
		...
		cout<<"\t\t\t@@|                                                    |@@\n";
		cout<<"\t\t\t@@|******************< Developer >*********************|@@\n";
		cout<<"\t\t\t@@|__________________Prashant Kumar____________________|@@\n";
		cout<<"\t\t\t@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\t\t\t\t\t";
...
void deposit_withdraw(int n, int option)
{
	...
	while(!File.eof() && found==false)
	{
		...
		if(ac.return_ac_no()==n)
		{
			...
			{
				cout<<"\n\n\t\t\tTO DEPOSIT AMOUNT :\n";
				cout<<"\n\n\t\t\t\tAmount only deposited in bundle of 5000\n\n\t\t\t\t No. of bundle you wants to deposit :";
				cin>>bundle;
